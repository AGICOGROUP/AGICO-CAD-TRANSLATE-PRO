...
5. Run `assemble-translations`, then import. Import performs the pre-import language gate internally and runs only the selected pipeline.
...
7. Review only changed or high-risk regions using `references/visual-audit.md`.
