...
{
    public static bool IsTitleField(string label) => Normalize(label) is "审定" or "设总" or "审核" or "校核" or "校对" or "设计" or "制图"
    ...
    {
        var fields = labels.Where(IsTitleField).Select(Normalize)
